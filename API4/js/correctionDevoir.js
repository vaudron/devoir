            ...
            case "text":
                {
                    ...
                    $.ajax({
                        ...
                        data: "fichier=../correction/type_text.html",
                        dataType: "html",
            ...
            case "manuelle":
                {
                    ...
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_manuel.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
                    });
                    $("#menuCorrection #mcManuel").val(boite);
                    $("#" + boite).addClass("correct");
            ...
            case "case":
                {
                    ...
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_case.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
            ...
            case "radio":
                {
                    ...
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_radio.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
            ...
            case "drop":
                {
                    ...
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_drop.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
            ...
            case "cloze":
                {
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_cloze.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
            ...
            case "text_selectable":
                {
                    ...
                    $.ajax({
                        async: false,
                        url: site+API+"/php/loadQuestion.php",
                        data: "fichier=../correction/type_txt_selectable.html",
                        dataType: "html",
                        success: function(data) {
                            $("#menuCorrection").html(data);
                        }
    ...
    this.setCode = function(event) {
        ...
        switch (event) {
            ...
            case "manuel":
                {
                    ...
                    var manuel = $("#menuCorrection #mcManuel").val();
                    var groupe = "manuel";
                    var txt = "";
                    if (manuel != "") {
                        groupe = "manuel" + manuel;
            ...
            case "manuelle":
                {
                    var id = $(this.ebauche.selection.objets[0]).attr("id");
                    var boite = $("#menuCorrection #mcManuel").val();
                    var view = $("#page span[id*=q]").attr("id");
                    var bareme = $("#menuCorrection #mcBareme").val();
                    var comment = $("#menuCorrection #mcComment").val();
                    $("#" + id).find("bareme").text(bareme);
                    $("#" + id).find("comment").text(comment);
                    $("#" + id).find("boite").text(boite);
                    var groupe = "manuel" + $("#menuCorrection #mcManuel").val().substring(5);
                    $("#" + id).find("manuel").text(groupe);
                    txt = 'evaluateManuel("' + boite + '","' + groupe + '",' + bareme + ',"' + view + '","' + comment + '")';
                    $("#" + id).find("code").text(txt);
            ...
            case "drop":
                {
                    var id = $(this.ebauche.selection.objets[0]).attr("id");
                    var boite = "boite" + id.substring(5);
                    $("#" + id).find("boite").first().text(boite);
                    var iff = $("#" + id).find("if").first().text();
                    var note = $("#" + id).find("note").first().text();
                    var view = $("#page span[id*=q]").attr("id");
                    $("#" + id).find("view").first().text(view);
                    var comment = $("#" + id).find("comment").first().text();
                    var code = 'evaluateDrop("' + boite + '","' + iff + '",' + note + ',"' + view + '","' + comment + '");';
                    $("#" + boite + " code").first().text(code);
                    /*
                    var tab = iff.split(",");
