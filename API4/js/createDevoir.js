...
var CreatePage = function() {
    ...
    this.saveAllQuestions = function() {
        ...
        $.ajax({
            ...
            //url: "https://leducdenormandie.itslearning.com/editor/save_file_content.aspx?Edit=1&Type=4&Course="+coursID+"&Filename=questions.html&Path="+cheminDossier+"&RedirectAfterwards=%2fFileExplorer%2fBrowseFiles.aspx%3fType%3d4%26PopUp%3d%26Function%3d0%26Page%3d-1%26GenerateAbsolutePath%3dFalse%26Path%3d%255cdevoir%255ctest&FileName=questions.html",
            // https://leducdenormandie.itslearning.com/Editor/edit_file_content.aspx?Page=-1&Type=4&Course=44383&Path=\devoir\test&RedirectAfterwards=%2fFileExplorer%2fBrowseFiles.aspx%3fType%3d4%26PopUp%3d%26Function%3d0%26Page%3d-1%26GenerateAbsolutePath%3dFalse%26Path%3d%255cdevoir%255ctest&FileName=questions.html
            url: site + API + "/php/saveQuestions.php",
            type: "POST",
            dataType: "html",
            //data: "code=" + contenuHtml + "&path=" + window.location.pathname,
            data: "code=" + contenuHtml + "&path=/" + dvCoursID + cheminDossier,
            //data: contenuHtml,
            success: $.proxy(function(data) {
