...
(function () {
    ...
    var TextBlock = P(Node, function (_, super_) {
        ...
        _.html = function () {
            return (
                '<span class="mq-text-mode" mathquill-command-id=' + this.id + '>' + this.textContents() + '</span>'
            );
        };
    ...
    */
    ...
    var Variable = P(Symbol, function (_, super_) {
        ...
        _.text = function () {
            ...
            if (this[L] && !(this[L] instanceof Variable) && !(this[L] instanceof BinaryOperator))
                text = '*' + text;
            if (this[R] && !(this[R] instanceof BinaryOperator) && !(this[R].ctrlSeq === '^'))
                text += '*';
            return text;
        };
    });
    ...
    CharCmds['*'] = LatexCmds.times =
        bind(BinaryOperator, '\\times ', '&times;');
    ...
    if (transformPropName) {
        ...
        scale = function (jQ, x, y) { //NOTE: assumes y > x
            ...
            var innerjQ = jQ.children()
                .css('filter', 'progid:DXImageTransform.Microsoft' + '.Matrix(M11=' + x + ",SizingMethod='auto expand')");
    ...
    var SummationNotation = P(MathCommand, function (_, super_) {
        _.init = function (ch, html) {
            var htmlTemplate =
                '<span class="mq-large-operator mq-non-leaf">' + '<span class="mq-to"><span>&1</span></span>' + '<big>' + html + '</big>' + '<span class="mq-from"><span>&0</span></span>' + '</span>';
