...
var CreatePage = function() {
    ...
    this.saveAllQuestions = function() {
        ...
        //envoie du document
        $.ajax({
            url: location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + "/devoir/API4/saveQuestions.php",
            type: "POST",
            dataType: "html",
